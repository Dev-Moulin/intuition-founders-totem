    ...
    <div className="p-3 bg-white/5 rounded-lg border border-white/10">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          title={t('founderExpanded.withdraw')}
        >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        <div className="flex items-center gap-1 flex-1">
          <input
            ...
            className="w-20 bg-white/5 border border-white/10 rounded px-2 py-1 text-sm text-white focus:outline-none focus:border-slate-500/50"
          />
      ...
      {item.needsWithdraw && (
        <div className="text-xs text-yellow-400/80 flex items-center gap-1">
          ...
          {t('founderExpanded.oppositePositionWarning')}
        </div>
      )}
      ...
      {item.isNewTotem && (
        <div className="text-xs text-blue-400/80 flex items-center gap-1">
          ...
          {t('founderExpanded.newTotemInfo')}
        </div>
      )}
    </div>
  );
...
function CostSummarySection({ summary }: { summary: VoteCartCostSummary }) {
  ...
  return (
    <div className="p-3 bg-slate-500/10 border border-slate-500/20 rounded-lg">
      <h4 className="text-xs font-semibold text-slate-400 mb-2">{t('founderExpanded.summary')}</h4>
  ...
  if (!cart || cart.items.length === 0) {
    return (
      <div className="p-4 bg-white/5 border border-white/10 rounded-lg text-center">
        <p className="text-white/40 text-sm">{t('founderExpanded.emptyCart')}</p>
