...
### Note : Utilisation de Base Mainnet

**Pour ce projet**, nous utilisons également **Base Mainnet** (Chain ID: 8453) pour une seule fonction :
- ✅ **Vérification NFT** : Vérifier que l'utilisateur possède un NFT de la collection "Overmind Founders" (whitelist)

Toutes les autres opérations (atoms, triples, votes) se font sur **INTUITION L3 Testnet** (Chain ID: 13579).
...
```bash
pnpm install @0xintuition/sdk @0xintuition/protocol viem@2.x.x
```
