...
- Upload d'une image
- Sera stockée sur IPFS via Pinata
...
3. Attendre la confirmation (5-10 secondes sur Base)
...
### Off-chain (optionnel, cache)
- Lien rapide entre wallet et propositions
- Compteurs de propositions
- Cache GraphQL
...
**Image :** [Upload d'une image de lion]
