...
| Catégories | `Animal`, `Objet`, `Trait`, `Concept`, `Element`, `Mythologie` | 6 catégories | À créer |
...
### Panneau Centre - Vote Market / Totems
```
┌───────────────────────────────────────────────────────────┐
